...
class Task_Space_Control():
    ...
    def JLA_1(self,del_X):  # Inequality Constraint Method
        i = 0
        d_theta = np.ones((6,1))  # defining an array to store joint velocity
        ...
        Plot.figure()
        Plot.plot(range(1,Column),d_theta[0,1:Column], 'r-')
        Plot.plot(range(1,Column),d_theta[1,1:Column], 'b-')
        Plot.plot(range(1,Column),d_theta[2,1:Column], 'g-')
        Plot.plot(range(1,Column),d_theta[3,1:Column], 'y-')
        Plot.plot(range(1,Column),d_theta[4,1:Column], 'c-')
        Plot.plot(range(1,Column),d_theta[5,1:Column], 'm-')
